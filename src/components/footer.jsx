        ...
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400">
                        <li><button className="hover:text-white transition-colors">Cakes</button></li>
                        <li><button className="hover:text-white transition-colors">Pastries</button></li>
                        <li><button className="hover:text-white transition-colors">Cupcakes</button></li>
                        <li><button className="hover:text-white transition-colors">Desserts</button></li>
                    </ul>
                </div>
